...
class Format
{
    ...
    static function userMinimal(array $values, string $field, array $objects, object $format, $options): array{
        if(is_null($options)){
        ...
        return Formatter::formatMany('user-minimal', $rows, $options, 'id');
    }
